...
export function toChoices(value: MarkValue | undefined): number[] {
...
export function sameChoices(a: MarkValue | undefined, b: MarkValue | undefined): boolean {
...
/** 정답이 둘 이상 = '모두 고르기' 문항 */
export function isMultiAnswer(value: MarkValue | undefined): boolean {
...
export function formatChoices(value: MarkValue | undefined, dash = "—"): string {
...
/** 엑셀 저장용 — [2,4] → "2,4" */
export function serializeChoices(value: MarkValue | undefined): string {
  const list = toChoices(value);
